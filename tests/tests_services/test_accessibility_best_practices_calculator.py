...
from services.accessibility_best_practices_calculator import LighthouseWrapper, \
    LighthouseError, AccessibilityError, BestPracticesError
...
class TestLighthouseWrapper(unittest.TestCase):
    ...
    def test_get_accessibility(self, mock_run):
        ...
        mock_run.return_value = Mock(stdout=json.dumps(mock_response).encode('utf-8'))
